...
pub struct Connection<M> {
    ...
    last_msg: Option<M>,                    /* latest message */
}

impl<M> Connection<M> where M: msg::Message + Clone {
    ...
    pub fn last_msg(&self) -> Option<M> where M: msg::Message + Clone {
        self.last_msg.clone()
    }

    pub fn add_msg(&mut self, message: M) where M: msg::Message + Clone {
